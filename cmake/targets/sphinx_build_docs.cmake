...
foreach(_LANGUAGE ${LANGUAGE_LIST})
    ...
    execute_process(
        COMMAND ${CMAKE_COMMAND} -E env
                ...
                -D html_baseurl=${BASEURL_HREF}                     # Used by custom.py.
                -D current_language=${_LANGTAG}                     # Used by custom.py.
                -D current_version=${VERSION}                       # Used by custom.py.
                -j ${SPHINX_JOB_NUMBER}
                ${SPHINX_VERBOSE_ARGS}
...
set(UPSTREAM_DOCS   "https://docs.conan.io")
set(UPSTREAM_REPO   "https://github.com/conan-io/docs")
