...
message(STATUS "Clearing the content of '_themes/conan_theme/versions.html' file...")
set(VERSIONS_HTML_PATH  "${PROJ_OUT_REPO_DOCS_DIR}/_themes/conan_theme/versions.html")
if (EXISTS "${VERSIONS_HTML_PATH}")
    file(WRITE "${VERSIONS_HTML_PATH}" "")
else()
    file(TOUCH "${VERSIONS_HTML_PATH}")
endif()
remove_cmake_message_indent()
message("")
message("Cleared the content of '_themes/conan_theme/versions.html' file.")
message("File: ${VERSIONS_HTML_PATH}")
message("")
restore_cmake_message_indent()


message(STATUS "Modifying 'current_version.startswith' in '_themes/conan_theme/layout.html' file...")
set(CONAN_THEME_LAYOUT_HTML_FILE  "${PROJ_OUT_REPO_DOCS_DIR}/_themes/conan_theme/layout.html")
...
if (NOT POSITION EQUAL -1)
    ...
    remove_cmake_message_indent()
    message("")
    message("Modified '_themes/conan_theme/layout.html' file.")
    ...
    remove_cmake_message_indent()
    message("")
    message("No need to modify '_themes/conan_theme/layout.html' file.")
    message("File: ${CONAN_THEME_LAYOUT_HTML_FILE}")
    message("")
    restore_cmake_message_indent()
endif()
